...
const T: Record<Lang, Record<string, string>> = {
  en: {
    ...
    ical_export: 'Add to Calendar (.ics)',
    copy_link: 'Copy link',
    copied: 'Copied!',
    badge_outdoor: 'Outdoor',
    ...
    cal_select_day: 'Select a day to see events',
  },
  de: {
    ...
    ical_export: 'Zu Kalender hinzufügen (.ics)',
    copy_link: 'Link kopieren',
    copied: 'Kopiert!',
    badge_outdoor: 'Outdoor',
    badge_family: 'Familienfreundlich',
    filter_outdoor: '🌳 Nur Outdoor',
    filter_family: '👨‍👩‍👧 Familienfreundlich',
    cal_prev: 'Vorheriger Monat',
    cal_next: 'Nächster Monat',
    cal_no_events: 'Keine Events an diesem Tag.',
    cal_select_day: 'Tag auswählen für Events',
  },
};
